...
public class GUIConference{
	...
	public GUIConference(String file) {
		...
		makeFrame();
		/* 
		 * Try to create a new model.Conference object using the given filename.
		 * 
		 * There are several kinds of Exceptions that can happen:
		 * IOException, NumberFormatException & Exceptions.BadDataFormatException
		 * 
	...
	private void makeFrame(){
		frame = new JFrame("model.Conference");
